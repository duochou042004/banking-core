...
| Plan or review work | [Agent harness](agents/harness.md), [evaluations](agents/evaluations.md), [plugin catalog](agents/plugin-catalog.md), [roadmap](delivery/roadmap.md) |
